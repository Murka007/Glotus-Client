...
// import { EItem, EWeapon, ItemType, TItemType, TWeapon, TWeaponData, TWeaponType, WeaponType, WeaponTypeString } from "../types/Items";
// import { fixTo, formatButton, getAngle, getAngleFromBitmask, isActiveInput, toRadians } from "../utility/Common";
...
//      */
//     readonly hotkeys = new Map<string, TItemType>();
...
//      */
//     lastHoldingItemType!: TItemType | null;
...
//             this.heal(true);
//             this.heal(true);
//         } else if (myPlayer.shameActive) {
//             this.equip(EStoreType.HAT, EHat.BULL_HELMET, "UTILITY");
//         }
...
//         if (this.canAutomill) {
//             if (this.canPlace(ItemType.WINDMILL)) {
//                 const angle = getAngleFromBitmask(this.move, true)!;
//                 const item = Items[myPlayer.getItemByType(ItemType.WINDMILL)];
//                 this.place(ItemType.WINDMILL, angle - toRadians(item.scale));
//                 this.place(ItemType.WINDMILL, angle + toRadians(item.scale));
//             } else {
//                 this.automillToggle = true;
//             }
//         }
